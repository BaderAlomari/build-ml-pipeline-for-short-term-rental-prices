...
@hydra.main(config_name='config', config_path='.', version_base='1.3')  # for newer hydra version add: , config_path='.', version_base='1.3')
    ...
    #   "output_description": "Data with outliers and null values removed",
      ...
      "max_price": config['etl']['max_price']
        ...
        if "train_random_forest" in active_steps:
            ...
            rf_config = "src/train_random_forest/rf_config.json"
